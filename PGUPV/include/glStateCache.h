...
namespace PGUPV {
	...
	Al llamar al m�todo BlendingState::restore, se restaurar� dicho estado.
	*/
	class BlendingState {
	public:
		/**
		Captura el estado de blending en el momento de crear el objeto. Captura si est�
		  activo o no, el color constante de blending, la ecuaci�n y las funciones de blending
		 */
		void capture();
	...
	*/
	...
	public:
		/**
		Captura la definici�n del viewport en este momento.
		*/
		void capture();
		/**
	...
	En el constructor captura el modo de dibujado de los pol�gonos, y el m�todo restore lo restaura
	*/
	class PolygonModeState {
	public:
		void capture();
	...
	En el constructor captura el valor de los atributos gen�ricos, y el m�todo restore lo restaura
	*/
	class GenericAttribState {
	public:
	...
	En el constructor captura el estado actual de las m�scaras de color, y el m�todo restore lo restaura
	*/
	class ColorMasksState {
	public:
		ColorMasksState();
	...
	En el constructor captura el estado actual del depth testing, y el m�todo restore lo restaura
	*/
	class DepthTestState {
	public:
		DepthTestState();
	...
	En el constructor captura si est� activado o no el Stencil, y el m�todo restore lo restaura
	*/
	class StencilTestEnabledState {
	public:
	...
	En el constructor captura si la m�scara de escritura del stencil, y el m�todo restore lo restaura
	*/
	class StencilMaskState {
	public:
		StencilMaskState();
	...
	En el constructor captura el programa instalado, y el m�todo restore lo restaura
	*/
	class CurrentProgramState {
	public:
		CurrentProgramState();
	...
	*/
	...
	public:
		/**
		Captura el estado del test de la tijera (on/off y la definici�n del �rea)
		*/
		void capture();
		/**
